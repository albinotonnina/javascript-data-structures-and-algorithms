...
describe('HashTable', () => {
  it('should pass every test', () => {
    ...
    expect(hashT.retrieveAll()).toEqual([
      undefined,
      [['Boo Radley', '520-589-1970'], ['Tom Bradey', '520-589-1970']],
      [['Vance Carter', '120-589-1970']],
      [['Alex Hawkins', '510-599-1930'], ['Rick Mires', '520-589-1970']],
      undefined,
      undefined,
    ...
    expect(hashT.retrieveAll()).toEqual([
      undefined,
      [['Boo Radley', '520-589-1970'], ['Tom Bradey', '818-589-1970']],
      [['Vance Carter', '120-589-1970']],
      [['Alex Hawkins', '510-599-1930'], ['Rick Mires', '650-589-1970']],
      undefined,
      undefined,
    ...
    expect(hashT.retrieveAll()).toEqual([
      ...
      undefined,
      undefined,
      [['Boo Radley', '520-589-1970'], ['Ricky Ticky Tavi', '987-589-1970']],
      undefined,
      undefined,
      undefined,
      undefined,
