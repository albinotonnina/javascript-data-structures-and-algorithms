...
describe('isPalindrome', () => {
  ...
  it('should spot the palindrome right', () => {
    expect(isPalindrome("T. Eliot, top bard, notes putrid tang emanating, is sad; I'd assign it a name: gnat dirt upset on drab pot toilet.")).toBeTruthy()
  })
  ...
  describe('Performance', () => {
    ...
    it('will display perftime with another palindrome', () => {
      displayPerfTime('isPalindrome("long one")', () => {
        isPalindrome("T. Eliot, top bard, notes putrid tang emanating, is sad; I'd assign it a name: gnat dirt upset on drab pot toilet.")
      })
    })
  })
})
