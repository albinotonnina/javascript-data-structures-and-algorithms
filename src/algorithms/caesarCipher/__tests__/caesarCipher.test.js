  ...
  describe('Performance', () => {
    it('will display perftime', () => {
      ...
      displayPerfTime("caesarCipher('long string', 1)", () => {
        caesarCipher('a long string to test Caesar Cipher a long string to test Caesar Cipher a long string to test Caesar Cipher', 1)
      })
    })
    ...
    it('will display perftime', () => {
      ...
      displayPerfTime("caesarCipher2('long string', 1)", () => {
        caesarCipher2('a long string to test Caesar Cipher a long string to test Caesar Cipher a long string to test Caesar Cipher', 1)
      })
    })
    ...
    it('will display perftime', () => {
      ...
      displayPerfTime("caesarCipher3('long string', 1)", () => {
        caesarCipher3('a long string to test Caesar Cipher a long string to test Caesar Cipher a long string to test Caesar Cipher', 1)
      })
    })
    ...
    it('will display perftime', () => {
      ...
      displayPerfTime("caesarCipher4('long string', 1)", () => {
        caesarCipher4('a long string to test Caesar Cipher a long string to test Caesar Cipher a long string to test Caesar Cipher', 1)
      })
    })
  })
})
